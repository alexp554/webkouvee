                        ...
                        <div class="panel-body">
                            <form method="post" action="/customer/{{$customer->id_customer}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('tgl_lahir_customer') is-invalid @enderror" id="tgl_lahir_customer" name="tgl_lahir_customer" placeholder="Masukkan Tanggal Lahir" value="{{$customer->tgl_lahir_customer}}">
                                    @error('tgl_lahir_customer')
                                        <div class="ivalid-feedback text-danger">{{$message}}</div>
                                    @enderror
                                    <br>
                                    <label for="nomor telepon">Nomor Telepon</label>
                                    <input type="text" class="form-control @error('telepon_customer') is-invalid @enderror" id="telepon_customer" name="telepon_customer" placeholder="Masukkan Nomor Telepon" value="{{$customer->telepon_customer}}">
